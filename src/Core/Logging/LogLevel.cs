namespace Game.Framework.Logging
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="Trace"/> 是诊断噪音（注册/解析/重试等），受 <c>FrameworkLog.Verbose</c> 开关 + 仅 Editor/Development 输出双重门控——
    /// 对应旧 <c>FrameworkLog.LogVerbose</c> 的语义。<see cref="Info"/> 及以上始终广播给 sink，由各 sink 自行决定去向
