...
namespace Game.Framework.UI.UGui.Editor.Tests
{
    ...
    public sealed class UICodeGenProjectAgnosticTests
    {
        ...
        public void NativeFolderPicker_StoresPortableAssetPaths()
        {
            ...
            string projectGameFolder = Path.Combine(Application.dataPath, "Game");
            Assert.That(UICodeGenEditorGUI.TryToAssetPath(projectGameFolder, out string gamePath), Is.True);
            Assert.That(gamePath, Is.EqualTo("Assets/Game"));
        }
    }
}
