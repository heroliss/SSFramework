...
当前产品建议是 **Steam / Windows 首发、风格化俯视角 3D、付费单机、紧凑型沙盒**；领跑概念《游牧工坊》围绕“探索与回收 → 布置生产 → 抵御风暴 → 带着成果迁徙”循环展开。它仍需通过概念表达、共享灰盒和目标玩家反馈与备选方案对比，不能因为适合展示 Framework 或生成式资产就直接锁定。平台顺序、范围盒、概念矩阵和证据 Gate 见[首款商业 3D 游戏：产品与平台策略](commercial-3d-game-strategy.md)。
