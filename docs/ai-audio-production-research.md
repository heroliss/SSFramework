...
| 场景 | 音效材料 | 音乐身份 | 应避免 |
|---|---|---|---|
| 车内日常 | 帆布受风、铜管、继电器、旧电机、木质家具、远处脚步 | 温暖木质拨弦 + 低速机械脉冲；让发动机成为“家的心跳” | 所有设备都使用尖锐金属声，长期形成听觉疲劳 |
| 行驶与车外 | 履带碾压砂砾、车体低频形变、风切、远雷、无线电与地貌反射 | 保留同一动机，随速度、地貌和安全程度改变节奏与配器密度 | 用持续宏大末日音乐填满安静旅途，掩盖居民与车辆状态 |
| 故障与天气压力 | 松动零件、滤芯堵塞、结构冲击、风暴低频和局部告警 | 从常态层逐步加入失真打击、低音和不稳定脉冲，而不是硬切战斗曲 | 告警音彼此相似、混音只靠整体变响、压力结束后没有听觉恢复 |
