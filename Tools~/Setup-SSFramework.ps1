...
$frameworkGitUrl = 'https://github.com/heroliss/SSFramework.git#bdf01b583210b83bb4850010b95ddcc633aa66d8'
Write-Host ''
...
elseif ($addedFramework) { Write-Host '  SSFramework：将固定提交 bdf01b5 加入清单，Unity 启动后自动下载。' }
...
if ($CheckNetwork -and -not $SkipNetworkCheck -and $manifestChanged) {
    ...
    if ($addedFramework) { $plan.NetworkChecks += Test-SetupEndpoint 'SSFramework / GitHub' 'https://raw.githubusercontent.com/heroliss/SSFramework/bdf01b583210b83bb4850010b95ddcc633aa66d8/package.json' 'com.liss.ssframework' }
