...
$frameworkGitUrl = 'https://github.com/heroliss/SSFramework.git#0d8e5b439a9e36b902330ef43358b3f86cc6853c'
Write-Host ''
...
elseif ($addedFramework) { Write-Host '  SSFramework：将固定提交 0d8e5b4 加入清单，Unity 启动后自动下载。' }
...
if ($CheckNetwork -and -not $SkipNetworkCheck -and $manifestChanged) {
    ...
    if ($addedFramework) { $plan.NetworkChecks += Test-SetupEndpoint 'SSFramework / GitHub' 'https://raw.githubusercontent.com/heroliss/SSFramework/0d8e5b439a9e36b902330ef43358b3f86cc6853c/package.json' 'com.liss.ssframework' }
